...
public enum ModeScreenReference {
    ...
    public static func compare(screen: Data,startup: Data,menu: Data,loading: Data,catalog: Data,sounds: Data,
        ...
        let objects = Dictionary(uniqueKeysWithValues: metadata.objectAddresses.enumerated().map { ($0.element,UInt32($0.offset)) })
        ...
        var cases = 0,events = 0,helpers = 0,records = 0,bytes = 0,draws = 0,keys = 0,backgrounds = 0,playback = 0,callbacks = 0
        ...
        return .init(parent: parent,cases: cases,events: events,helpers: helpers,records: records,bytes: bytes,draws: draws,keys: keys,backgrounds: backgrounds,playback: playback)
    }
}
