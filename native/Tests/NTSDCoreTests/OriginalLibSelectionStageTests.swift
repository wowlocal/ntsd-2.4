...
final class OriginalLibSelectionStageTests: XCTestCase {
    ...
    func testRetainedComputerAndArenaSelectionWithLibraryText() throws {
    ...
    func testLateComputerPortraitAndArenaTextRollBackCurrentCall() throws {
        let r=try Resources()
        for (label,failure) in [("cpu1-right-release","computerPortrait"),("arena-none-release","arenaText")] {
