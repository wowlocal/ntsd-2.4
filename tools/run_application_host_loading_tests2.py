...
from run_application_host_loading_validation2 import main as run_one
...
def main(task):
    ...
    selection = dict(schema='ntsd-host-loading-test-commands-v1', cases=cases, packageCheck=pin(task/'package-check1.json'),
        ...
        runner=pin(ROOT/'tools/run_application_host_loading_validation2.py'), completeResultParser='same exact named XCTest regex and one-test zero-failure summary as Catalog53 completion')
