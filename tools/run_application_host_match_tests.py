...
from run_application_host_match_validation import main as run_one
...
def main(task):
    ...
    selection = dict(schema='ntsd-host-match-test-commands-v1', cases=cases, packageCheck=pin(task/'package-check1.json'),
        ...
        runner=pin(ROOT/'tools/run_application_host_match_validation.py'), completeResultParser='same exact named XCTest regex and one-test zero-failure summary as Catalog53 completion')
