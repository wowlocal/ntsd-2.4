...
Более ранний [STARTUP_PANEL](STARTUP_PANEL.md) теперь сравнивает настоящий
43cf94..43cfb4. В нём нет двух попыток и cache writer этого4236d0: только один
последовательный reader/content/bitmap и defaults при неуспехе. Собственный
результат startup ещё не соединён с полной ранней загрузкой/этим menu parent;
прежние266 cases остаются отдельными неизменными контрактами.
