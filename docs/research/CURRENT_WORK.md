...
[Provenance Actor50](APPLICATION_ACTIVE_LIFECYCLE_PROVENANCE.md) проверяет96 saved
...
NEXT — [полное сравнение lifecycle](APPLICATION_ACTIVE_LIFECYCLE_PLAN.md) из
