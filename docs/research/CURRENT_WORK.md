...
[Native window geometry passes all76 methods](APPLICATION_MAC_WINDOW_GEOMETRY.md):
...
[Observed bitmap Host integration passes all69 methods](APPLICATION_OBSERVED_BITMAP_CORRECTION1.md):
