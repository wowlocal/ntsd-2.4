...
The enabled panel has its separate whole [MENU_PANEL_DRAW](MENU_PANEL_DRAW.md)
comparison and controlled enclosing [MODE_PANEL_SCREEN](MODE_PANEL_SCREEN.md)
composition with live resources. This screen's retained boundary fixture remains
unchanged; the own initialized menu chain is still open.
