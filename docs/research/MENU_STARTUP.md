...
Следующее естественное продолжение — dispatch429e5a/431d10 и выбор персонажей,
затем подготовка выбранного матча. Новый natural corpus не расширяет проверку
