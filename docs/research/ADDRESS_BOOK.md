...
| --- | --- | --- | --- |
| R01/R02/R14 | `41bc90..41bff0`, own caller; stop `4450ac` | Пролог загрузки после доставленного выбора меню, MENU_WAIT,18 WAV,count18,present, запрос каталога | D+Native [APPLICATION_LOADING_PREFIX](APPLICATION_LOADING_PREFIX.md):9 префиксов до запроса81273768байт/SP1000e430;3 rejected40187a,187WAVret/33helpers,223states. BodySP1000e43c; полный каталог/ret4/Windows открыт |
...
| R02/R15 | CRT `0x78182857`, `0x78182153`, `0x78181e8e`, `0x781819dd`; caller separately below | Startup FILETIME/localtime, own timezone/DST/tm cache | D+Native [CALENDAR_TIME](CALENDAR_TIME.md):10844 whole returns+3 original-stop rejections,198 precise DST boundaries,1843CRT starts; exact bytes/masks and rollback. Controlled OS/environment, whole EXE caller/Windows open |
| R02/R15/R17 | `0x43d100..0x43d21f/ret16` | Message priority, owned MSG/baseline/counter, selected whole WndProc callbacks, actual epilogue | D+Native [APPLICATION_MESSAGE_LOOP](APPLICATION_MESSAGE_LOOP.md):63 loop returns at declared OS/body boundaries+1 own required43e9a0 stop;215 completed iterations/131 callbacks/896 events,100/100loop starts. Whole dispatcher/recovery/Windows/application remain open |
| R02/R15/R17 | `0x43e8e0..0x43e934`, `0x401250..0x401281` | Surface query, live black clear and diagnostic result | D+Native [APPLICATION_ART_SETUP](APPLICATION_ART_SETUP.md):231 whole controlled calls/693 requests,43 executed starts; retained local/global chain and late rollback. Own stack/full dispatcher/Windows remain open |
| R02/R15/R17 | `0x43e860..0x43e88b`, `0x43e890..0x43e8d4` | Restore results, whole destruction/recreation, flags and ShowWindow result | D+Native [APPLICATION_RECOVERY](APPLICATION_RECOVERY.md):318 whole recovery returns+3 own initializations;1 ordinary null-back source fault rejected separately.5113 requests/565 EXE starts; own chains and late rollback. Full dispatcher/WinMain/Windows remain open |
| R02/R15/R17 | `0x43e9a0` → `0x4246b0` → required `0x4450ac` | Own startup surfaces and static World458b00, art/clear, first front allocation | D+Native [APPLICATION_DISPATCH_ENTRY](APPLICATION_DISPATCH_ENTRY.md):8 own prefixes/40 events/48 stores/135 EXE starts; first1f50 allocation unreturned.160 owned request bytes compare,1696 opaque bytes remain unknown. Whole pending-loop rollback; full dispatcher/Windows open |
| R13/R15 | `0x43ed10..0x43ee4f`, `0x4013d0..0x4014d1` | Image fallback, dimensions, surface creation and GDI copy/cleanup | D+Native [BITMAP_SURFACE_LOADING](BITMAP_SURFACE_LOADING.md):59 direct returns+2 unknown-field rejections;8 own front prefixes/177 constructors to7 settings boundaries and1 NULL metadata stop. Full106 loader/88 copy starts;239 old pins unchanged. Windows pixels/full dispatcher open |
| R02/R15 | `0x423480`, `0x427089..0x42709b` | Own settings after full WinMain/loop/front parents; produced scratch and restored target | D+Native [APPLICATION_SETTINGS](APPLICATION_SETTINGS.md):17 whole returns,1 missing-FILE stop;888 CRT returns,825 scratch reads, seven parent variants; World/dispatcher and Windows open |
| R02/R13/R15 | `0x42709b..0x427127`, alternate `0x4275cb` | Own early screen with complete background loader/copy, private fill masks and cached Sleep | D+Native [APPLICATION_FRONT_SCREEN](APPLICATION_FRONT_SCREEN.md):40 prefixes+1 pre-NULL stop,41 fresh parents,363 helper returns/1266 events; whole World/dispatcher/worker/Windows remain open |
| R02/R13/R15 | queued `0x43b3d0`, repeated `0x43e9a0/0x4246b0`, actual `0x41bc90` entry | Own input -> single-player click -> World1/2/loading entry | D+Native [APPLICATION_MENU_INPUT](APPLICATION_MENU_INPUT.md):50chains/62completeiterations,9callbacks/9000actualrand/3backgroundfrees,3pending loadingcalls SP1000ea6c; full loading/worker/Windows/app open |
| R02/R13/R15 | `0x4275cb..0x428805/ret4`, `0x43ecbf..0x43ed01/ret`, loop `0x43d187..0x43d110` | Own early-menu World/dispatcher return and first due iteration | D+Native [APPLICATION_MENU_RETURN](APPLICATION_MENU_RETURN.md):47 full iterations,1 pre-NULL cursor stop;1159events/476helpers/94actualABI returns; own baseline123456822/counter2; worker/CRT/Windows/app open |
| R02/R13/R15 | `0x427127..0x4275cb`, whole `0x4236d0`, installed `0x401290` | Own early-screen body with produced strings/target/selector and library DC | D+Native [APPLICATION_SCREEN_BODY](APPLICATION_SCREEN_BODY.md):43 whole panel/body calls,344 helper returns/6650 events; all39 critical parents exact; whole dispatcher/worker/Windows remain open |
| R02/R15 | `0x43cf40..0x43d100`, continuous WinMain prefix | Own seed, window/panel/settings, dates/music/cursor and input/all5WAVs | D+Native [WINMAIN_STARTUP](WINMAIN_STARTUP.md):23 whole chains+5 source-stop+7 unknown-provenance rejections;6325 compared events/119 WAV results.128/132caller starts,1906EXE/2140CRT. Earlier CRT/NLS, fullscreen/private backing, message loop/WinMain return/Windows/app open |
| R02/R15 | `0x43cfb4..0x43d078` | Startup dates, wrapping expiry, whole music and cursor | D+Native [STARTUP_OUTPUT](STARTUP_OUTPUT.md):49 whole callers+9 stopped-boundary rejections,64/64caller starts,1414 ordered events and globals between events. Own tm failure-zero provenance and full rollback; earlier/full WinMain/Windows/app open |
| R02/R15 | `0x43cf94..0x43cfb4`, all4 children | Startup info/content/bitmap/default selection and own shared locals | D+Native [STARTUP_PANEL](STARTUP_PANEL.md):212 whole callers+8 unknown-read rejections,10/10caller starts,32 own replacement pairs. Own184-byte local overlap, complete globals/resources/output and rollback; earlier/full WinMain/app/Windows open |
