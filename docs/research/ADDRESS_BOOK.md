...
| R02/R04/R05 | `0x41e339..0x41e634`; `0x403270..0x4034d3`, `0x4034e0..0x4034ea` | Полный400-slot control caller, телепортации и превращения/связанные объекты | D [WORLD_CONTROL](WORLD_CONTROL.md):1491 synthetic/full pool+masks и оба собственных MATCH_LAUNCH до41e634; дальше полная физика40e490/caller41e634..41eed1 |
