...
| R02/R15 | `0x42709b..0x42712c`, `0x4237e0`, `0x423840`, `0x4236d0` | Выбор раннего экрана, fill, фон, bitmap caller42710f | S: следующая ветвь после полного settings helper; источник450be8 теперь установлен, D/native соединённого экрана ещё открыто |
