...
| R02/R15 | CRT `0x78182857`, `0x78182153`, `0x78181e8e`, `0x781819dd`; caller `0x43cfb4..0x43d078` pending | Startup FILETIME/localtime, own timezone/DST/tm cache | D+Native [CALENDAR_TIME](CALENDAR_TIME.md):10844 whole returns+3 original-stop rejections,198 precise DST boundaries,1843CRT starts; exact bytes/masks and rollback. Controlled OS/environment, whole EXE caller/Windows open |
