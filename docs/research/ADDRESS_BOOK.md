...
| R02/R15 | `0x427915..0x427ca7`, фрагмент | Пять пунктов меню, поля/flags, подсветка, RNG, звук, ShellExecute | D против Swift: [MAIN_MENU.md](MAIN_MENU.md),1020probes/4150events; до42873e/4287de, bitmap request boundary, panel null/empty; общий tail открыт |
