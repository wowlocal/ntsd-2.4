...
| R04/R05/R14 | `0x413080..0x4143cb`, вся функция; `0x417090..0x417162` | Общий контроль Actor и stereo accumulator | D [ACTOR_CONTROL](ACTOR_CONTROL.md),25 795 synthetic и5376 случаев/42 исходных type0 Object; полный World caller/тактовый цикл ещё открыт |
