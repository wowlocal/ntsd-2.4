...
| R02/R15 | `0x423480..0x4236c8`, call `0x427089`, clear `0x427092` | Чтение data/control.txt, затем снятие44d068 | S: следующий разрыв ранней загрузки; фактические CRT/file semantics и native comparison ещё открыты |
