...
| R02/R15/R16 | `0x402d70..0x402eb6`, caller `0x427f6b` | Выход из сети: optional sendto exit notice, close/clear и WSACleanup | S [NETWORK_CLIENT](NETWORK_CLIENT.md): исправлено прежнее ошибочное имя «client handshake»; whole source/native join остаётся открытым |
