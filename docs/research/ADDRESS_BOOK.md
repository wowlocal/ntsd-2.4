...
| R02/R15 | `0x4236d0..0x4237d3`, `0x427127` | Следующий critical-section helper и тело экрана | S: состояние458424==2 ведёт к43c780/43cc60/43c690/43c710; весьhelper и новый caller ещё открыты |
| R02/R15 | `0x43c780..0x43cc53` | Загрузчик информационной панели: пути,24 ba/8 ta/un/y/end | D704 отдельных случаев [MENU_CONTENT.md](MENU_CONTENT.md), actual VC80 sprintf/fgets/sscanf, persistent globals/полный scratch; исходные ad0/ad1 отсутствуют, present-file inputs контрольные; parent4236d0/W открыты |
| R02/R13/R15 | `0x43cc60..0x43cf3a` | Замена bitmap458420 и11 буквальных rectangles | D118 отдельных случаев [MENU_PANEL_BITMAP.md](MENU_PANEL_BITMAP.md):102 constructors/100 destructors, все live/dead поколения и44 повторные выдачи адреса; malloc/DIB/COM inputs supplied, parent4236d0/W открыты |
| R02/R15 | `0x43c690..0x43c708`, `0x43c710..0x43c77e` | Запись default/cache adinfo и путей | D534 отдельных случаев [MENU_INFO_WRITING.md](MENU_INFO_WRITING.md), actual VC80 sprintf/fprintf/fclose, все FILE/buffer/globals, short/error writes; user-buffered FILE и descriptor IO supplied, parent4236d0/W открыты |
