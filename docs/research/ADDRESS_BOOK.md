...
| --- | --- | --- | --- |
| R01/R02/R15 | `421a2d..421cdc`, весь caller | Диагностика, exit/function-key notices; реальные VC80/401290/415160/43f010/43ef70 | D+Native: [POSTHUD_NOTICES](POSTHUD_NOTICES.md),819 прямых совпадений +8 явно отличающихся sNaN/Unicorn случаев с QNaN-парами;4 cookie-overwrite отклонены.195/198callerPC; own/Windows ещё открыты |
