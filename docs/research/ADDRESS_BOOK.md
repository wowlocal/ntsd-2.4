...
| R02/R05/R06/R10 | `0x41f550..0x41fb0b`, префикс одного слота | Трансформации, частицы9996, HP/MP и полный scheduler; неактивный выход4214c6 | D [POSTDRAW_SLOT_PREFIX](POSTDRAW_SLOT_PREFIX.md):897 controlled calls/329 instructions/full pool+masks/globals/retained SP+70 и2334 events; whole loop/own chain открыты |
