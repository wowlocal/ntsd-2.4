...
| R02 | `0x422ac0..0x422af7`; callers `0x427a2c/0x427a71` | Заполнение 3000 bytes RNG через CRT rand()%255+1 и нулевой хвост450b48 | S следующего этапа; seed timeGetTime→srand в43cf55/43cf5a, промежуточные CRT consumers и menu provenance ещё открыты |
