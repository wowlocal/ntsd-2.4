...
| R02/R15 | `0x42712c..0x4275cb`, фрагмент | Продолжение раннего экрана после panel update, строки и дальнейший вывод | S: следующие28/31/29 bytes из EXE копируются в stack и декодируются byte subtract index&3 с повторным strlen; остальное тело и альтернативы4275cb — следующая задача |
