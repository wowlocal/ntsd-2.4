...
| R02/R15 | `0x4297ae..0x429e5a`, особенно429b21/429c50 |11 menu bitmap, три массива8 слов, частичная SPARK-разметка и сброс44d07c | S: CHARMENU,CM1..5,CMA/CMA2,CMC,RFACE,SPARK; последний malloc0 разыменовывается, не безопасный skip. D/native продолжение открыто |
