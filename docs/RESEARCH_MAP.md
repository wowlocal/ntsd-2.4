...
globals. Нет новых обработчиков персонажей. Полный400-slot caller и физика
в собственном матче ещё не соединены; следующий шаг — от41e339 через
состояния400/401/500/501 и весь оставшийся такт. Контроль одного Actor,
...
| R04 — ввод, комбо и переходы | Local/remote/playback input/control, hotkeys; весь Actor413080 и helpers | Общий raw input,9 комбо, DAT-переходы, движение/атаки и стоимость без допуска по имени; Practice ещё не заменена | D606 local/1452 received/5986 control cases;14 624 префикса и31 171 [целого управления](research/ACTOR_CONTROL.md), включая42 исходных type0 Object | Соединить функцию с собственным World/caller/полным тактом; расширять непрерывные игровые последовательности |
...
| 4 | **R04.1 — общий переход в кадр: в работе** | Объявленная готовая часть R02.1 и проверенные записи R03.1 | [ACTOR_CONTROL](research/ACTOR_CONTROL.md): общий переход и целый413080 перенесены;14 624 проверки префикса,25 795 whole-function synthetic и5376 случаев/42 исходных type0 Object совпали; непрерывные игровые последовательности и собственный400-slot caller ещё открыты |
