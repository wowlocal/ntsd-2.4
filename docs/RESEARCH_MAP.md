...
| R02 — структуры, глобальное состояние, RNG | Конструкторы, полный enabled catalog, CRT/table, menu/presentation, preparation/replay, round control и собственный запуск через hits/items/cpoints | Собственная цепочка загрузка→меню→Naruto/Sasuke/District→Start→music/replay→новый игровой вход→control/physics/links/contacts/hits/cpoints/camera/background до41f496; новая основа ещё вне Practice | D полных записей/масок/вызовов и изменяемого Frame heap, две собственные цепочки без подстановки ожидаемого состояния; ОС/CPU — явные границы | На собственном41f496:41a5a0..41ae50/40de30 рисунок объектов, mode branches/планировщик/восстановление и полный такт; paused render, ранний playback, animated loading, остальные экраны/режимы, CRT lifetime/Windows |
...
| R13 — сцена, камера, спрайты, HUD | Полные41b5d0/41a250/41a050, границы/камера/фон, bitmap draw43f010/43ef70/415160; whole actor draw ещё открыт | Общий400-slot camera pass, DAT layers/parallax/counters, встроенная99 и настоящие bitmap/fill requests; отдельно прежнее окно Practice | D4742 [WORLD_CAMERA](research/WORLD_CAMERA.md), обе собственные цепочки до41f496 и3971 isolated bitmap cases; DAT survey302 слоя17 арен | Весь41a5a0..41ae50/40de30, исходный HUD/эффекты/порядок, pixel device/масштаб, подключение к приложению и Windows |
