...
индивидуальной поддержки персонажей не добавлено. Следом — окружающие
трансформации, восстановление HP/MP, создание и удаление в исходном порядке
слотов. Первый собственный такт всё ещё останавливается перед этим обходом.
...
| R05 — состояния, движение, планировщик | Целые413080/40e490/40d960 и physics caller41e634..41eed1 | Общие управление/физика и новый OriginalActorScheduler; собственный World до41f550, планировщик ещё отдельно | D55 433 [Actor physics](research/ACTOR_PHYSICS.md), включая все15363 кадра137Object;515 World physics и6084 [scheduler](research/ACTOR_SCHEDULER.md) calls/756 sounds | Общий post-draw caller/полный такт, непрерывные DAT-последовательности, Windows и оставшиеся числовые границы |
