...
| R15 — меню, настройки и режимы | Все5главных пунктов, mouse, tail/World1→2, подготовка,10 initial UI resources и24 ранних wrappers с UI/font metadata;43c780 content; полный поток экранов открыт | Тренировочное окно; отдельно menu/state/presentation и initial UI/content lifecycle, пока не UI приложения | D1020main-menu probes/450mouse messages,1482tail/dispatcher returns,13initial UI passes и290front-resource/188settings/356screen-prefix/704content cases; prelude/continuation | Bitmap43cc60 и cache43c690/43c710 → весь4236d0/тело427127 и альтернативы4275cb, полный loading path, ранние экраны/вывод, World2→429730, выбор персонажей/арены, начало/конец/рестарт, настройки; Battle, Stage и Tournament |
