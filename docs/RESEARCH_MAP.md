...
**Ближайший шаг: [ограниченные серии активного ввода и продолжения loaded caller](research/CONTINUOUS_GAMEPLAY_PLAN.md),
затем внешний цикл времени и подключение общего движка к приложению.**
...
[PAUSED_HUD](research/PAUSED_HUD.md) проверяет1789 целых вызовов HUD callee
с сохранением командных флагов:283090 событий,477 исходных PCs. Новый
`drawPreservingCommands` нужен паузе; полный paused caller и собственная
инициализированная pause/resume цепочка остаются открытыми.
