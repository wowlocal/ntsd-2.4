...
Следующий этап — соединение загруженного каталога с World/Actor, инициализация
выбранного матча, оставшиеся типы и обоснованное состояние для широкого такта.
...
| R02 — структуры, глобальное состояние, RNG | Конструкторы, пул, совместный полный каталог, Frame/heap, частичный словарь/снимок | Конструкторы/пул, весь каталог с Object/BG/Stage и общими ресурсами, RNG; новый storage ещё вне игрового цикла | D всех загруженных записей/масок против Swift; сырой снимок шести случаев | Каталог → World/Actor, выбранный матч, остальные типы/владельцы, provenance и полная нормализация снимка |
...
| 2 | **R02.1 — состояние такта: в работе** | Карта R01.1 | [Карточка](research/R02.1.md), [словарь](research/STATE_LAYOUT.md), [пул](research/BOOTSTRAP.md), [загруженный каталог](research/LOADED_CATALOG.md): соединение с World/Actor, выбранный матч, оставшийся словарь и полный снимок открыты |
