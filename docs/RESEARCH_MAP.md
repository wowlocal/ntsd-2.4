...
проход выполнил все 137 Object в исходном порядке. Далее перенести перекрытия
имени/указателя/индекса Frame и десятый лист, сравнить весь реестр с Swift и
соединить дочерние загрузчики с родителем.
...
| R02 — структуры, глобальное состояние, RNG | Конструкторы, пул, родитель каталога, целые объявленные Object, все исходные BG/Stage, частичный словарь/снимок | Конструкторы/пул/родитель, заголовки/bitmap Object и BG/layer lifecycle/Stage с масками, RNG; новый storage ещё вне игрового цикла | D объявленных областей против Swift; сырой снимок шести случаев; S остальных областей каталога | Полный Object-реестр и соединение каталога, выбранный матч, остальные типы/владельцы, provenance и полная нормализация снимка |
| R03 — загрузка DAT целиком | Режимы декодера, все исходные Object/BG/Stage, реестр, секции кадров; decimal scanf MSVCR80 .6195 | Общие Object/Frame/BG/Stage loaders, decoder и wrap32; практика ещё использует импорт | D объявленных целых Object, всех 17 BG и 25 Stage, integer CRT; весь Object-реестр исполнен без полного нативного сравнения | Raw Frame имя/ссылки/маски, десятый лист, нативное сравнение всего реестра, полные CRT/file I/O, соединение с родителем |
