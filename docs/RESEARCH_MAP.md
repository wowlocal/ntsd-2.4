...
| R04 — ввод, комбо и переходы | Local/remote/playback input/control, hotkeys; весь префикс Actor413080..4132ef и его helpers | Общий raw input,9 комбо, DAT-переходы и стоимость без допуска по имени; Practice ещё не заменена | D606 local/1452 received/5986 control cases;14 624 [Actor input](research/ACTOR_INPUT.md) synthetic probes, полные байты/маски | Соединить новый компонент с остатком управления/полным тактом; проверить переходы на разных исходных файлах и непрерывных игровых последовательностях |
...
| 4 | **R04.1 — общий переход в кадр: в работе** | Объявленная готовая часть R02.1 и проверенные записи R03.1 | [ACTOR_INPUT](research/ACTOR_INPUT.md): общий `0x40e2d0`/комбо/приоритеты перенесены,14 624 synthetic probes совпали; проверки разных исходных файлов и соединение полного управления ещё открыты |
