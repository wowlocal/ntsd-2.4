...
сохраняются. Далее11 menu bitmap и таблицы4297ae..429e5a, тело431d10,
паузный вывод и gameplay. Музыкальный вывод/Windows ещё не проверены.
