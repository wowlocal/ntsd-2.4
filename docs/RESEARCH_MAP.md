...
области каталога. Инициализация выбранного матча/каталога и оставшиеся типы открыты.
...
| R02 — структуры, глобальное состояние, RNG | Конструкторы, загрузочный пул, основные области каталога, частичный словарь/снимок | Конструкторы и пул с масками/ссылками по индексам, структуры практики, RNG; новый storage ещё вне игрового цикла | D конструкторов/пула против Swift; сырой снимок шести случаев; S каталога | Инициализация каталога/выбранного матча, остальные типы/владельцы, provenance и полная нормализация снимка |
...
| 2 | **R02.1 — состояние такта: в работе** | Карта R01.1 | [Карточка](research/R02.1.md), [словарь](research/STATE_LAYOUT.md), [загрузочный пул](research/BOOTSTRAP.md): конструкторы/пул перенесены; инициализация каталога/матча, оставшийся словарь и полный снимок открыты |
...
Карточка 2 начата; 3–5 пока остаются очередью. Их нельзя закрывать
