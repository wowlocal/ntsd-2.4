...
Инициализация всего матча/каталога и оставшиеся типы ещё открыты.
...
| R02 — структуры, глобальное состояние, RNG | Точные конструкторы Actor/World, частичный словарь, сырой снимок/globals; полный матч не закрыт | Конструкторы с масками и битовым хранением, структуры практики, RNG; новый storage ещё вне игрового цикла | D конструкторов против Swift; сырой снимок шести случаев; прежние корпусы | Инициализация пула/каталога, оставшиеся типы/владельцы, provenance и полная нормализация снимка |
...
| 2 | **R02.1 — состояние такта: в работе** | Карта R01.1 | [Карточка](research/R02.1.md), [частичный результат](research/STATE_LAYOUT.md): конструкторы перенесены; инициализация пула/каталога, оставшийся словарь и полный снимок ещё открыты |
